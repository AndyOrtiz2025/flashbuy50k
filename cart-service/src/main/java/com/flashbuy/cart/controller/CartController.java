package com.flashbuy.cart.controller;

import com.flashbuy.cart.model.CartItem;
import com.flashbuy.cart.repository.CartItemRepository;
...
BigDecimal(body.get("unit_price").toString()));

        return ResponseEntity
                .status(201)
                .body(cartItemRepository.save(item));
    }
